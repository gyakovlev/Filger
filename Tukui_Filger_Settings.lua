...
Filger_Spells = {
	...
	["WARLOCK"] = {
		...
		},
		{
			...
			Interval = 4,
			Mode = "ICON",
			setPoint = { "LEFT", UIParent, "CENTER", 160,31},
			-- Chaos bolt
			...
			-- Shadowflame
			{ spellID = 47897, size = 47, filter = "CD" },
		},
		{
			Name = "P_LONG_CD_ICON",
			Direction = "LEFT",
			Interval = 4,
			Mode = "ICON",
			setPoint = { "RIGHT", UIParent, "CENTER", -160,31},
			-- Meta
			{ spellID = 59672, size = 47, filter = "CD" },
			-- Soulburn
			{ spellID = 74434, size = 47, filter = "CD" },
			-- Shadowfury
			{ spellID = 30283, size = 47, filter = "CD" },
			-- Shadow ward
			{ spellID = 6229, size = 47, filter = "CD" },
			-- Death Coil
			{ spellID = 6789, size = 47, filter = "CD" },
			-- Howl of Terror
			{ spellID = 5484, size = 47, filter = "CD" },
		},

		{
			...
			-- Bane of Havoc
			{ spellID = 80240, size = 47, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Bane of Agony
			...
			-- Shadow Embrace
			{ spellID = 32385, size = 47, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Shadowflame
			{ spellID = 47897, size = 47, unitId = "target", caster = "player", filter = "DEBUFF" },
		},
		{
			Name = "F/DEBUFF_BAR",
			Direction = "UP",
			...
			Interval = 4,
			Mode = "BAR",
			setPoint = { "LEFT", UIParent, "CENTER", 160, 74 },

			-- Fear
			{ spellID = 5782, size = 32, barWidth = 162, unitId = "focus", caster = "all", filter = "DEBUFF" },
			-- Banish
			{ spellID = 710, size = 32, barWidth = 162, unitId = "focus", caster = "all", filter = "DEBUFF" },
		},
	},
	["ROGUE"] = {
		{
