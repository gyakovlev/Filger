			...
			if (self.Mode == "ICON") then
				...
				if (bar.statusbar) then
					...
					if ( self.IconSide == "LEFT" ) then
						bar.statusbar:SetPoint("BOTTOMLEFT", bar, "BOTTOMRIGHT", TukuiDB.Scale(6), TukuiDB.Scale(2));
					elseif ( self.IconSide == "RIGHT" ) then
						bar.statusbar:SetPoint("BOTTOMRIGHT", bar, "BOTTOMLEFT", TukuiDB.Scale(-6), TukuiDB.Scale(2));
					end
				end
